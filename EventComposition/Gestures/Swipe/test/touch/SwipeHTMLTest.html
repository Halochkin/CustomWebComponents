...
<head>
    ...
    <script src="src/SwipeTest.js"></script>
...
<script>
  ...
  let swipeStart = undefined;
  let swipeMove = undefined;
  ...
  window.addEventListener("swipe-stop", e => {
    if (Math.abs(e.detail.distX) < 100) return;
    viewport.children[0].style.transform = e.detail.distX < 0 ? "rotate(15deg)" : "rotate(-15deg)";
    viewport.children[0].style.marginLeft = e.detail.distX < 0 ? "-650px" : "650px";
