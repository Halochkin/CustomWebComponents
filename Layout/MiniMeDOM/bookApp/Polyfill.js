...
//Setup: declare the function for loading script sync
  ...
  loadScriptSync(url, onAsyncLoadAsString) {
...
.
  prototype;
  var;
  ES6 = window.Promise && Array.from && window.URL && window.Symbol;
  var;
  TE = !(function () {
  ...
  const;
  base = "https://rawgit.com/webcomponents/webcomponentsjs/master/bundles/";
