...
const MAIN_DOMAIN = 'http://localhost:63342';
const GOOGLE_JWT_LINK = 'https://accounts.google.com/o/oauth2/v2/auth';
const GOOGLE_CLIENT_ID = '610949901122-aibgual35655bq9dmfuqd8qi11qhbo8p.apps.googleusercontent.com';
const GOOGLE_CLIENT_SECRET = 'L09-fKuOMpe5rhj8hCdH9qgw';
const GOOGLE_REDIRECT_URI = 'http://localhost:63342/login';
